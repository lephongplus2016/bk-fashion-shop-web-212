                                        ...
                                        <?php 
                                            ...
                                            if($brandlist != false) { 
                                                while ($row = $brandlist->fetch_assoc()) { 
                                                    ...
                                                    $brand_link_name = vn_to_str($row["brandName"]);
                                                    ?>
                                                                        
                                                <li><a href="brand/<?php echo $brand_link_name; ?>"><?php echo $row['brandName']; echo " ($num)";?></a></li>
                        ...
                        <div id="collapseThree" class="collapse show" data-parent="#accordionExample">
                            <div class="card-body">
                                <div class="shop__sidebar__price">
                                    <ul>
                                        <li><a href="price/level-0"> 0 - 200.000</a></li>
                                        <li><a href="price/level-1"> 200.000 - 500.000</a></li>
                                        <li><a href="price/level-2">500.000 - 1.000.000</a></li>
                                        <li><a href="price/level-3">1.000.000 - 2.000.000</a></li>
                                        <li><a href="price/level-4">2.000.000 - 5.000.000</a></li>
                                        <li><a href="price/level-5">5.000.000+</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
